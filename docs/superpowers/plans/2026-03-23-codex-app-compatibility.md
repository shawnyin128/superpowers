...
| `skills/using-sp-harness/references/codex-tools.md` | Codex platform reference | Add detection + finishing docs |
...
**Files:**
- Modify: `skills/using-sp-harness/references/codex-tools.md:25` (append at end)

- [ ] **Step 1: Read the current file**

Read `skills/using-sp-harness/references/codex-tools.md` in full. Confirm it ends at line 25-26 after the multi_agent section.
...
```bash
git add skills/using-sp-harness/references/codex-tools.md
...
- `skills/using-sp-harness/references/codex-tools.md` — two new sections at end
