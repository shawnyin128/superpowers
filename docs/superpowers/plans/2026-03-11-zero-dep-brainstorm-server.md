...
> **For agentic workers:** REQUIRED: Use sp-harness:subagent-driven-development (if subagents available) or sp-harness:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.
